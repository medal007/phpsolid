...
$runadd1 = dbquery("INSERT INTO " .$table6. " (groupname, role, action, date_created) VALUES ('".dbescape($groupname)."', '".dbescape($pages)."', '".dbescape($actions)."', '".dbescape($currentdate)."')");
if($runadd1 > 0){
    notify($adminname. " added " .$groupname, "All");
    echo '<script language="javascript">';
    echo 'alert("New User Group Added!")';
    echo '</script>';
