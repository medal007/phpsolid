...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $projectname ?> - Manage Pages</title>
    ...
    <body>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="mt-5">
                            <h4 class="header-title mb-3">Manage Pages List&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#myModal">Add New Page <i class="fas fa-plus"></i></button></h4>
                            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                    <?php 
                                        $getpages = dbquery("SELECT * FROM ".$table3." ORDER BY pagenumber ASC")->rows;
                                        foreach($getpages as $pages){
                                            $pid = $pages['id'];
                                            $pagename = $pages['pagename'];
                                            $pagenumber = $pages['pagenumber'];
                                            $pagestatus = $pages['pagestatus'];
                                            $pageicon = $pages['pageicon'];
                                            $date = $pages['date_created'];
                                            $ago = getdiff($date);
                                    ?>
                                    <tr>
                                        <td><i class="<?php echo $pageicon ?> fa-3x"></i></td>
                                        <td><?php echo $pagename ?></td>
                                        <td><?php echo $pagestatus ?></td>
                                        <td><?php echo $ago ?></td>
                                        <td>
                                            <!-- <button class="btn btn-warning btn-sm viewbtn" data-id="<?php echo $pid ?>" title="View Page Actions"><i class="fas fa-eye" aria-hidden="true"></i></button> -->
                                            
                                            <button class="btn btn-success btn-sm moveupbtn" data-id="<?php echo $pid ?>" title="Move Up"><i class="fas fa-arrow-up" aria-hidden="true"></i></button>
                                            <button class="btn btn-success btn-sm movedownbtn" data-id="<?php echo $pid ?>" title="Move Down"><i class="fas fa-arrow-down" aria-hidden="true"></i></button>
                                            
                                            <a href="../structure/<?php echo $pid ?>"><button type="button" class="btn btn-warning btn-sm structurebtn" data-id="<?php echo $pid ?>" title="Page Structure"><i class="fas fa-cubes"></i></button></a>
                                            
                                            <button type="button" class="btn btn-primary btn-sm editbtn" data-id="<?php echo $pid ?>" title="Edit"><i class="fas fa-edit"></i></button>
                                            <button class="btn btn-danger btn-sm delbtn" data-id="<?php echo $pid ?>" title="Delete "><i class="fas fa-trash" aria-hidden="true"></i></button>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <select name="pagestatus" class="form-control addpagestat">
                            <option value="onepager">One Pager</option>
                            <option value="multipager">Multi Pager</option>
                            <option value="restrictedpager">Restricted Pager</option>
                        </select>
                        
                        <div style="display:none;" id="showrole">
                            <h5 class="font-14">Select A Role That Can Access The Page<span class="text-danger">*</span></h5>
                            <select id="addgrouprole" name="pagerole" class="form-control">
                        ...
                        <!-- <h5 class="font-14">Select Page Actions<span class="text-danger">*</span></h5>
        ...
        <div id="viewModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">View Page Actions</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <h5 class="font-14">Page Status<span class="text-danger">*</span></h5>
                        <select id="editpagestatus" name="pagestatus" class="form-control editpagestat">
                            <option value="onepager">One Pager</option>
                            <option value="multipager">Multi Pager</option>
                            <option value="restrictedpager">Restricted Pager</option>
                        </select>
                        
                        <div style="display:none;" id="editshowrole">
                            <h5 class="font-14">Select A Role That Can Access The Page<span class="text-danger">*</span></h5>
                            <select id="editgrouprole" name="pagerole" class="form-control">
                                <?php $getrole = dbquery("SELECT * FROM ".$table6." ORDER BY id ASC")->rows;
                                        foreach($getrole as $role){
                                            $gid = $role['id'];
                                            $groupname = $role['groupname'];
                        ...
                        <select id="pactions" name="actions[]" class="form-control select2-multiple" data-toggle="select2" multiple="multiple" data-placeholder="Choose ...">
                            <option value="Add">Add</option>
                            <option value="Update">Update</option>
                            <option value="Delete">Delete</option>
                        </select> -->
        ...
        <div id="deleteModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <center>
                        <h5 class="font-14"><span class="text-danger">Are you sure you want to delete this Page?.</span></h5>
                        <h5 class="font-14"><span class="text-danger">It may affect some data related to it.</span></h5>
                        </center>
                    </div>
                    <input type="hidden" name="pageid" parsley-trigger="change" required  class="form-control" id="delpageid">
                    <input type="hidden" name="pagename" parsley-trigger="change" required  class="form-control" id="delpagename">
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">Close</button>
        ...
        <script>
            ...
            //              var pageaction = datanow[0].pageaction;
                         
            //              $('#viewaction').tagsinput('removeAll');
                         
            //              var tagAction = $('#viewaction');
            //              tagAction.tagsinput();
            //              var actionarray = pageaction.split(',');
            ...
            $(document).on("click", ".editbtn", function () {
                 ...
                 $.ajax({
                  ...
                  success: function(datanow){
                        ...
                        //  var pageaction = datanow[0].pageaction;
                         var pagerole = datanow[0].pagerole;
                         
                         if(pagerole != "0"){
                             $('#editshowrole').show();
                             
                             var pageroleopts = document.getElementById("editgrouprole").options;
                             for(var i = 0; i < pageroleopts.length; i++) {
                                if(pageroleopts[i].value == pagerole) {
                                   var indexopt = i;
                        ...
                        //  $('#pactions option[value=' + add + ']').attr('selected', false).change();
                        //  $('#pactions option[value=' + update + ']').attr('selected', false).change();
                        //  $('#pactions option[value=' + delet + ']').attr('selected', false).change();
                         
                        //  var actionarray = pageaction.split(',');
                        //  for(var i=0; i<actionarray.length; i++){
                        //     $('#pactions option[value=' + actionarray[i] + ']').attr('selected','').change();
                        //  }
            ...
            $(document).on("click", ".delbtn", function () {
                 ...
                 $.ajax({
                  ...
                  success: function(datanow){
                    var pagename = datanow[0].pagename;
                    $('#delpagename').val(pagename);
                    $('#delpageid').val(pageId);
            ...
            $(document).on("click", ".moveupbtn", function () {
                var pageId = $(this).data('id');
                 ...
                 $.ajax({
                  ...
                  data: {pageId : pageId, type : "view"},
                  success: function(datanow){
                     var pageNo = datanow[0].pagenumber;
                     var pagetogo = pageNo - 1;
                     $.ajax({
                      url: './processflow.php',
                      type: 'POST',
                      dataType: 'json',
                      data: {pageNo : pageNo, pagetogo : pagetogo, type : "moveup"},
            ...
            $(document).on("click", ".movedownbtn", function () {
                 ...
                 $.ajax({
                  ...
                  success: function(datanow){
                     var pageNo = datanow[0].pagenumber;
                     var pagetogo = parseInt(pageNo) + 1;
                     
                     $.ajax({
                      url: './processflow.php',
                      type: 'POST',
                      dataType: 'json',
                      data: {pageNo : pageNo, pagetogo : pagetogo, type : "movedown"},
                      success: function(datanow1){
                          window.location.reload();
                        }
                    });
            ...
            $(document).on("change", ".addpagestat", function () {
                var statValue = $('.addpagestat :selected').text();
                
                if(statValue == "Restricted Pager"){
                    $('#showrole').show();
                } else{
                    $('#showrole').hide();
                }
            ...
            $(document).on("change", ".editpagestat", function () {
                var statValue = $('.editpagestat :selected').text();
