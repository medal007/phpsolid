...
$runadd1 = dbquery("UPDATE ". $table1 . " SET fullname = '".dbescape($fullname)."', email = '".dbescape($email)."', password = '".$password."', image = '".dbescape($url)."', role = '".dbescape($role)."' WHERE id = '".dbescape($userid)."'");

if($runadd1 > 0){
    notify($adminname. " edited " .$fullname, "All");
    echo '<script language="javascript">';
    echo 'alert("Admin User Updated!")';
    echo '</script>';
