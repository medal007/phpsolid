...
$getupid = dbquery("SELECT * FROM ".$table7." ORDER BY id DESC LIMIT 1")->rows;
$upid = $getupid[0]['id'];
...
if(isset($dataprocess)){
    ...
    $getfirst = dbquery("SELECT * FROM ".$table7." ORDER BY id DESC LIMIT 1")->num_rows;
    if($getfirst > 0){
        ...
        // print_r($values);
        // echo "<br>";
        // print_r($filestrucextra);
                
        foreach (array_combine($updatecols, $updatevals) as $updatecol => $updateval) {
            $runadd1 = dbquery("UPDATE ". $table7 . " SET $updatecol = $updateval WHERE id = '".dbescape($upid)."'");
        }
        if($getfilestrucname > 0 && $filestructype == "Select File"){
            $run1 = dbquery("UPDATE ". $table7 . " SET $filefieldname = '".dbescape($url)."' WHERE id = '".dbescape($upid)."'");
        }
        ...
        $runadd1 = dbquery("INSERT INTO " .$table7. " (".$columns.") VALUES (".$values.")");
        if($runadd1 > 0){
            $getlastinsert = dbquery("SELECT * FROM ".$table7." ORDER BY id DESC LIMIT 1")->rows;
            $lastinsertid = $getlastinsert[0]['id'];
            if($getfilestrucname > 0 && $filestructype == "Select File"){
                $run1 = dbquery("UPDATE ". $table7 . " SET $filefieldname = '".dbescape($url)."' WHERE id = '".dbescape($lastinsertid)."'");
            }
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="mt-5">
                            <h4 class="header-title mb-3"><?php echo $pgname ?> Page</h4>
                                <?php 
                                $getstructure = dbquery("SELECT * FROM ".$table4." WHERE pageid = '$pageid' AND strucactive = 'yes' ORDER BY strucnumber ASC")->rows;
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <?php if($structype == "Text" || $structype == "Email" || $structype == "Number" || $structype == "Phone" || $structype == "Address" || $structype == "City" || $structype == "URL"){ ?>
                                        ...
                                        <input id="<?php echo $lowerstrucname ?>" name="<?php echo $lowerstrucname ?>" required parsley-trigger="change" type="<?php echo $lowerstructype ?>" class="form-control <?php echo $lowerstrucname ?>" placeholder="<?php echo $strucname ?>">
                                    <?php } else if($structype == "Password"){?>
                                        <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                        <input id="edit<?php echo $lowerstrucname ?>" required parsley-trigger="change" type="<?php echo $lowerstructype ?>" class="form-control password <?php echo $lowerstrucname ?>" placeholder="<?php echo $strucname ?>">
                                    ...
                                    <?php } else if($structype == "Text Area"){?>
                                        <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                        <textarea name="<?php echo $lowerstrucname ?>" class="form-control <?php echo $lowerstrucname ?>" rows="5" id="<?php echo $lowerstrucname ?>" placeholder="<?php echo $strucname ?>"></textarea>
                                    <?php } else if($structype == "Default Time Picker"){?>
                                        <div class="input-group">
                                            <input id="timepicker" name="<?php echo $lowerstrucname ?>" type="text" class="form-control <?php echo $lowerstrucname ?>">
                                    ...
                                    <?php } else if($structype == "24Hrs Time Picker"){?>
                                        <div class="input-group">
                                            <input id="timepicker2" name="<?php echo $lowerstrucname ?>" type="text" class="form-control <?php echo $lowerstrucname ?>">
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="mdi mdi-clock"></i></span>
                                            </div>
                                        </div>
                                    <?php } else if($structype == "Color Picker"){?>
                                        <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                        <input type="text" name="<?php echo $lowerstrucname ?>" class="form-control <?php echo $lowerstrucname ?>" id="default-colorpicker" value="#8fff00">
                                    <?php } else if($structype == "RGBA Color Picker"){?>
                                        <div id="component-colorpicker" class="input-group" title="Using format option">
                                            <input type="text" name="<?php echo $lowerstrucname ?>" class="form-control input-lg <?php echo $lowerstrucname ?>" value="#188ae2" />
                                    ...
                                    <?php } else if($structype == "Date Picker"){?>
                                        <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                        <input type="date" name="<?php echo $lowerstrucname ?>" class="form-control <?php echo $lowerstrucname ?>" placeholder="mm/dd/yyyy" id="datepicker">
                                    <?php } else if($structype == "Clock Picker"){?>
                                        <div class="input-group clockpicker mb-3">
                                            <input type="text" name="<?php echo $lowerstrucname ?>" class="form-control <?php echo $lowerstrucname ?>" value="09:30">
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="mdi mdi-clock"></i></span>
                                            </div>
                                        </div>
                                    <?php } else if($structype == "Editor"){?>
                                        <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                        <textarea class="summernote <?php echo $lowerstrucname ?>" id="summernote" name="<?php echo $lowerstrucname ?>"></textarea>
                                        
                                    <?php } else if($structype == "Money"){?>
                                         <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                         <input id="<?php echo $lowerstrucname ?>" name="<?php echo $lowerstrucname ?>" required parsley-trigger="change" type="number" class="form-control <?php echo $lowerstrucname ?>" placeholder="<?php echo $strucname ?>">
                                        
                                    <?php } else if($structype == "Select File"){?>
                                        <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                        <input type="file" class="filestyle" name="<?php echo $lowerstrucname ?>" data-btnClass="btn-primary">
                                        <input id="<?php echo $lowerstrucname ?>" name="ex<?php echo $lowerstrucname ?>" required parsley-trigger="change" type="hidden" class="form-control <?php echo $lowerstrucname ?>">
                                        
                                    <?php } else if($structype == "Tags Input"){?>
                                        <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                        <input type="text" class="form-control <?php echo $lowerstrucname ?>"  name="<?php echo $lowerstrucname ?>" value="" data-role="tagsinput" placeholder="add <?php echo $lowerstrucname ?>" />
                                    ...
                                    <?php } else if($structype == "Icon Inputs"){?>
                                        <div class="input-group">
                                            ...
                                            <input type="<?php echo $typenme ?>" id="<?php echo $lowerstrucname ?>" name="<?php echo $lowerstrucname ?>" class="form-control <?php echo $lowerstrucname ?>" placeholder="<?php echo $strucname ?>">
                                        </div>
                                        
                                    <?php } else if($structype == "Input Select"){?>
                                        <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                        <select id="<?php echo $lowerstrucname ?>" name="<?php echo $lowerstrucname ?>" class="form-control <?php echo $lowerstrucname ?>" >
                                    ...
                                    <?php } else if($structype == "Disabled"){?>
                                        <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                        <input id="<?php echo $lowerstrucname ?>" name="<?php echo $lowerstrucname ?>" type="text" class="form-control <?php echo $lowerstrucname ?>"  readonly value="<?php echo ${$firstextra} ?>">
                                        
                                    <?php } else if($structype == "Enabled"){?>
                                        <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                        <input id="<?php echo $lowerstrucname ?>" name="<?php echo $lowerstrucname ?>" type="text" class="form-control <?php echo $lowerstrucname ?>"  value="<?php echo ${$firstextra} ?>">
                                    ...
                                    <?php } else if($structype == "Hidden"){?>
                                        <input id="<?php echo $lowerstrucname ?>" name="<?php echo $lowerstrucname ?>" type="hidden" class="form-control <?php echo $lowerstrucname ?>"  value="<?php echo ${$firstextra} ?>">
                                        
                                    <?php } else if($structype == "Toggle Button"){?>
                                        <div class="custom-control custom-switch">
                                            <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                            <input name="<?php echo $lowerstrucname ?>" type="checkbox" class="custom-control-input <?php echo $lowerstrucname ?>" id="<?php echo $lowerstrucname ?>">
                                    ...
                                    <?php } else if($structype == "Inline Checkboxes"){?>
                                        ...
                                        <?php for ($i = 0; $i < count($listextra); $i++){?>
                                            <div class="checkbox form-check-inline">
                                                <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                                <input class="form-control <?php echo $lowerstrucname ?>" name="<?php echo $lowerstrucname ?>" type="checkbox" id="<?php echo $listextra[$i] ?>" value="<?php echo $listextra[$i] ?>">
                                    ...
                                    <?php } else if($structype == "Inline Radios"){?>
                                        ...
                                        <?php for ($i = 0; $i < count($listextra); $i++){?>
                                            <div class="radio radio-info form-check-inline">
                                                <h5 class="font-14"><?php echo $strucname ?><span class="text-danger">*</span></h5>
                                                <input class="form-control <?php echo $lowerstrucname ?>" type="radio" id="<?php echo $listextra[$i] ?>" value="<?php echo $listextra[$i] ?>" name="<?php echo $lowerstrucname ?>" checked>
                                                <label for="<?php echo $listextra[$i] ?>"> <?php echo $listextra[$i] ?> </label>
                                            </div>
                                        <?php }?>
                            ...
                            <?php } ?>
                            <br>
                            <center><button type="submit" class="btn btn-success btn-lg updatebtn" title="Update">Update <?php echo $pgname ?>  <i class="fas fa-edit"></i></button></center>
                        </div>
                 ...
                 $.ajax({
                  ...
                  success: function(datanow){
                      ...
                      if(type == "Relationship" || type == "Input Select"){
                         var selopts = document.getElementsByClassName(code)[0].options;
                         console.log(selopts);
                         for(var i = 0; i < selopts.length; i++) {
                            if(selopts[i].value == content) {
                               var indexopt = i;
                               document.getElementsByClassName(code)[0].selectedIndex = indexopt;
                               break;
                            }
                         }
